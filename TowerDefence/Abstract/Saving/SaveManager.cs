...
public static class SaveManager
{
    ...
    public static bool SaveExists(string sceneName)
    {
        ...
        return global::BestagonDefence.Abstract.Saving.SaveLevel.LoadVersion(json) == ProjectSettings.GetSettingWithOverride("application/config/save_version").AsString();
    }
